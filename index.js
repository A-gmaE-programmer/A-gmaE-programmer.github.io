...
window.smoothTo = (cssQuery) => {
    let location = document.querySelector(cssQuery).getBoundingClientRect().y;
    let scrollContainer = document.querySelector('.scroll-container')
    console.log(location, document.querySelector(cssQuery))
    scrollContainer.scrollTo(0, location);
}

if (navigator.userAgent.indexOf("Firefox") > -1) {

    window.smoothTo = (cssQuery, time = 800) => {
        let location = document.querySelector(cssQuery).getBoundingClientRect().y;
        let scrollContainer = document.querySelector('.scroll-container')
    ...
    window.smoothTo = (cssQuery) => {
        let location = document.querySelector(cssQuery).getBoundingClientRect().y;
        let scrollContainer = document.querySelector('.scroll-container')
        scrollContainer.scrollTo(0, location + scrollContainer.scrollTop);
    }
}
